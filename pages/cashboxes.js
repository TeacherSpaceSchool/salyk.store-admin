...
const Cashboxs = React.memo((props) => {
    ...
    return (
        <App checkPagination={checkPagination} searchShow={true} pageName='Кассы'>
            <Head>
                <title>Кассы</title>
...
Cashboxs.getInitialProps = async function(ctx) {
...
export default connect(mapStateToProps)(Cashboxs);