        ...
        <App pageName='Публичная оферта'>
            ...
            <Card className={classes.page}>
                <CardContent>
                    ...
                    <p>Производя регистрацию на настоящем сайте (https://www.salyk.store), Лицензиат гарантирует, что ознакомлен, соглашается, полностью и безоговорочно принимает условия настоящего Договора.</p>
                    <p>Регистрируясь на настоящем сайте (https://www.salyk.store), Лицензиат подтверждает свои права и дееспособность, а также что он имеет законные права вступать в договорные отношения с ОсОО &laquo;АрхиКойн&raquo;</p>
                    ...
                    <p>1.2. Лицензиат &ndash; индивидуальный предприниматель или юридическое лицо, осуществившее регистрацию на сайте (https://www.salyk.store).</p>
                    <p>1.3. Стороны &ndash; стороны Договора (одновременное указание и на Лицензиара, и на Лицензиата).</p>
                    <p>1.4. Сайт &ndash; https://www.salyk.store.</p>
                    <p>1.5. Продукт &ndash; программно контрольно-кассовая машина с функцией передачи данных &laquo;ККМ SALYK.STORE&raquo; версии 1.0, внесенная в государственный реестр контрольно-кассовых машин исключительные имущественные права на которое принадлежат Лицензиару.</p>
