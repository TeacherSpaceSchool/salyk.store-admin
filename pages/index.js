            ...
            <div className={['кассир', 'admin', 'superadmin', 'оператор'].includes(profile.role)?classes.pageCenter:classes.page}>
                {
                    !profile.role?
                        <div style={{background: 'white', padding: 10, overflow: 'hidden'}}>
                            ...
                            <center><h2>ККМ SuperKassa v1.1</h2></center>
                            <p style={{textAlign: 'left'}}><strong>ККМ SuperKassa v1.1 - </strong>это кроссплатформенный виртуальный кассовый аппарат, который представляет собой программное обеспечение скачиваемое в PlayMarket и возможностью входа через сайт с браузера (персональный/переносной компьютер, мобильный телефон и другие аналогичные аппараты), принадлежащие субъекту предпринимательства, с помощью которого будут проводится кассовые операции.</p>
                            ...
                            <h2 style={{textAlign: 'center'}}><strong>Преимущества ККМ SuperKassa v1.1</strong></h2>
                            <table>
                                <tbody>
                                ...
                                <tr style={{height: '80px'}}>
                                    ...
                                    <td>
                                        <p><strong>Простые и интуитивно понятные настройки: </strong><span style={{fontWeight: 400}}>SuperKassa предлагает клиентам дополнительные сервисы и функции, которые могут облегчить работу и сэкономить на дорогом оборудовании.</span></p>
                                    </td>
                                </tr>
                                <tr style={{height: '80px'}}>
                                ...
                                <tr style={{height: '80px'}}>
                                    ...
                                    <td>
                                        <p><strong>Поддержка 24/7:</strong><span style={{fontWeight: 400}}> Специалисты помогают быстро зарегистрировать кассу, подключиться к ОФД и начать работу. Наши специалисты круглосуточно готовы помочь и проконсультировать вас по всем вопросам относительно услуг ОФД SuperKassa</span></p>
                                    </td>
                                </tr>
                                <tr style={{height: '80px'}}>
                                    <td><img src={`${urlMain}/privet/globe (1).png`} width={70} height={70} /></td>
                                    <td>
                                        <p><strong>География:<span style={{fontWeight: 400}}> Услуги ОФД SuperKassa оказывают на всей территории Кыргызской Республики.</span></strong></p>
                                    </td>
                                </tr>
                                <tr style={{height: '80px'}}>
                            ...
                            <p style={{textAlign: 'left'}}>&nbsp;</p>
                            <h2 style={{textAlign: 'center'}}>Стоимость услуг и тарифы ОФД SuperKassa</h2>
                            <center>
                                <table style={{borderCollapse: 'collapse', width: '100%', height: '162px', maxWidth: 800}} border={1}>
                                    ...
                                    <tr style={{height: '54px'}}>
                                        ...
                                        <td style={{width: '46.4345%', height: '54px', textAlign: 'left'}}>Оформление Договора о предоставлении услуг ОФД SuperKassa</td>
